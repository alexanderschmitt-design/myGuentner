...
export const CATEGORIES: CategoryDef[] = [
  { id: 0,  slug: 'evaporator-dx',   title: 'Evaporator', sublabel: 'DX',        productSection: 1, icon: '/icons/icon-dx.svg',        image: '/images/Evaporator-dx.png' },
  { id: 1,  slug: 'evaporator-pump', title: 'Evaporator', sublabel: 'Pump',      productSection: 1, icon: '/icons/icon-pump.svg',      image: '/images/Evaporator-Pump.png' },
  { id: 2,  slug: 'air-cooler',      title: 'Air cooler', sublabel: 'Coolant',   productSection: 1, icon: '/icons/icon-coolant.svg',   image: '/images/Aircooler.png' },
  { id: 3,  slug: 'condenser',       title: 'Condenser',  sublabel: '',          productSection: 1, icon: '/icons/icon-condenser.svg', image: '/images/Condenser.png' },
  { id: 4,  slug: 'dry-cooler',      title: 'Dry cooler', sublabel: '',          productSection: 1, icon: '/icons/icon-dry.svg',       image: '/images/Drycooler.png' },
  { id: 5,  slug: 'subcooler',       title: 'Subcooler',  sublabel: '',          productSection: 1, icon: '/icons/icon-sub.svg',       image: '/images/Condenser.png' },
  { id: 6,  slug: 'oil-cooler',      title: 'Oil cooler', sublabel: '',          productSection: 1, icon: '/icons/icon-pump.svg',      image: '/images/Drycooler.png' },
  { id: 10, slug: 'gas-cooler',      title: 'Gas cooler', sublabel: 'CO₂',       productSection: 1, icon: '/icons/icon-gascooler.svg', image: '/images/Gas-Cooler.png' }
]
